...
public class User implements Serializable {
    ...
    public User(Integer id, BigDecimal goldNum, Date updateTime, Integer payStatus) {
        this.id = id;
    ...
    public User(Integer id, boolean eroticismBehavior) {
        this.id = id;
    ...
    public Integer getCurrentAppId() {
        return AppIdConstant.getAppId(getAppId());
    }
