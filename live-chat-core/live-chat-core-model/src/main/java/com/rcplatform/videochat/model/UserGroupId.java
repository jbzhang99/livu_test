...
public class UserGroupId implements Serializable {
    ...
    @ApiModelProperty(value="facebook同组应用第三方id")
     ...
     * 获取facebook同组应用第三方id
     *
     * @return facebook_group_id - facebook同组应用第三方id
     */
     ...
     * 设置facebook同组应用第三方id
     *
     * @param facebookGroupId facebook同组应用第三方id
     */
    ...
    public String toString() {
        ...
        sb.append(", facebookGroupId=").append(facebookGroupId);
